...
const uint  SURFEL_CELL_CAPACITY    = 16;
...
struct SurfelStat {
    ...
    uint stack;     // stack pointer for free surfels
...
#define SURFEL_RAYGUIDE_BINDING     8
#define SURFEL_RADIAL_DEPTH_BINDING 9
